...
/* POSIX requires that an #include of <poll.h> define INFTIM, but many
   ...
   This is the standard value, but there's no gurantee it is -1. */
#ifndef INFTIM
...
/* Following shortens all the typecasts of pointers of pointer arguments: */
#define SA struct sockaddr
#define HAVE_STRUCT_SOCKADDR_STORAGE
#ifndef HAVE_STRUCT_SOCKADDR_STORAGE
/*
 * RFC 3493: protocal-independent placeholder for socket address
 */
